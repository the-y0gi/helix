    ...
    return (
        <section className="px-2 md:px-0 w-full mx-auto my-4">
            ...
            <div className="flex items-center gap-1 mb-6 cursor-pointer group">
                {!(city && category) ? (<h2 className="text-xl font-bold text-gray-900">
            ...
            <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                {fetchedCardsdata?.length > 0 && fetchedCardsdata.map((a: ActivityData) => (
                    <div key={a.title} className="space-y-3" onClick={() => {
