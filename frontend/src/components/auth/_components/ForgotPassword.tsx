...
import type { ResetPasswordProps, SignUpProps } from "@/schema/auth";
...
export function ForgotPasswordOTPForm({ onOTP, methods, setOnOTP, ...props }: OTPFormProps) {
    const { setValue } = useFormContext<ResetPasswordProps>();
