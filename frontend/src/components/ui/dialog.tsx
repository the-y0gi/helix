      ...
      >
        ...
        {showCloseButton && (<>
          ...
          <DialogPrimitive.Close
            data-slot="dialog-close"
            className="ring-offset-background focus:ring-ring absolute top-4 right-4 z-[1010] rounded-full p-1 opacity-70 transition-all hover:opacity-100 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/50 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none drop-shadow-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-8 text-zinc-800 dark:text-zinc-200"
          >
            <XIcon />
